...
/**
* Interface describing `dlastIndexOfRow`.
*/
interface Routine {
	/**
	...
	* // returns 2
	*/
	( order: Layout, M: number, N: number, A: Float64Array, LDA: number, x: Float64Array, strideX: number, workspace: Uint8Array, strideW: number ): number;
	...
	* // returns 2
	*/
	ndarray( M: number, N: number, A: Float64Array, strideA1: number, strideA2: number, offsetA: number, x: Float64Array, strideX: number, offsetX: number, workspace: Uint8Array, strideW: number, offsetW: number ): number;
}
...
* // returns 2
*/
declare var dlastIndexOfRow: Routine;


// EXPORTS //

export = dlastIndexOfRow;
